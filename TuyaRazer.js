...
export function Update() {
	// Aquí puedes agregar lógica periódica si hace falta
}
...
export function Shutdown() {
	// Apagar dispositivo si hace falta
}
...
export function DiscoveryService() {
	this.IconUrl = "https://github.com/BKMEN/signalrgb-tuya-battletron/raw/main/assets/logo.png";
